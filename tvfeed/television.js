/**
       ___________
      |.---------.|
      ||         ||    - The Javascript-based Television Feed Aggregator -
      ||  Alpha  ||     _       _            _     _
      ||         ||    | |_ ___| | _____   _(_)___(_) ___  _ __
      |'---------'|    | __/ _ \ |/ _ \ \ / / / __| |/ _ \| '_ \
       `)__ ____('     | ||  __/ |  __/\ V /| \__ \ | (_) | | | |
                        \__\___|_|\___| \_/ |_|___/_|\___/|_| |_|/-\+-+ ____
                                                                 \-/+-+/  _/
                                                                    | |  /_
                                                                 ___\_/ /__  /
                                                                  \____/__/ /
...
var isTv = true;
var bottomCounter = 0;
var TEMPLATES_OT = ' <div class="grid-item" id="vue-js-binding" v-for="tweet in tweets"> \
...
'; // originalText
var k; // counter for renderer
var TEMPLATES_BEFORE_K = ' <div class="grid-item hidden-binding-group-';
var TEMPLATES_BETWEEN_Ks = '" id="vue-js-binding-';
var TEMPLATES_AFTER_K = '" v-for="tweet in tweets" \
style="display: none;"> \
<div class="grid-item-post hvr-grow"> \
<div id="inline-media" v-if=" tweet.ifmediaexists "> \
<img src="{{ tweet.mediaurl }} " class="img-responsive" alt=""  data-toggle="modal" data-target="#{{ tweet.count }}"  /> \
...
var TEMPLATES_SIMPLE_TEMPLATE = ' <div class="grid-item" id="vue-js-binding" \
...
var handleResponse = function(status, response) {
        ...
        if (finalResult.length > 1) {
            originalText = OT;
            for (k = 1; k < finalResult.length; k++) {
                originalText = originalText + TEMPLATES_BEFORE_K + k + TEMPLATES_BETWEEN_Ks + k + TEMPLATES_AFTER_K;
            }
            ...
            document.getElementById("sma-widget-container").innerHTML = TEMPLATES_SIMPLE_TEMPLATE;
...
if (!isTv) {
    $("#sma-load-more-btn").click(function() {
        ...
        if (bottomCounter == 1) {
            ...
            $("#sma-load-more-btn").click(function() {
                window.location = 'http://www.lschs.org/news-events/socialmedia';
            });
